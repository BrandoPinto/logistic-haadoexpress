...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Articulos General'])
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between">
                <h4 class="p-2"><b>LISTADO GENERAL DE ARTICULOS</b></h4>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($articles as $item)
                                <tr class="text-center">
                                    ...
                                    <td class="align-middle">
                                        <span
                                            class="text-secondary text-xs font-weight-bold text-uppercase">{{ $item->company_name }}</span>
                                    </td>
                                    <td class="align-middle">
                                        <span class="text-secondary text-xs font-weight-bold text-uppercase">
                                            ...
                                            @endforeach
                                            @if (!$found)
                                                <span class="text-danger font-weight-bold">Si requiere <i
                                                        class="fas fa-exclamation-triangle ms-auto text-dark cursor-pointer"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Aquí le debe aparecer el precio, si no aparece solicítelo al encargado."></i></span>
                                            @endif
                                        @else
