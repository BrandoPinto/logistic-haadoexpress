    ...
    <table class="table align-items-center mb-0 table-users w-100">
        <thead class="text-white">
            <tr class="bg-primary text-white">
                <th class="text-uppercase text-center text-xxs font-weight-bolder" colspan="5">LISTADO DE ADMINS</th>
            </tr>
            <tr>
        ...
        <tbody>
            @foreach ($admins as $item)
                <tr @if ($loop->last) class="last-row" @endif>
                    ...
                    <td class="align-middle">Admin | <i class="fas fa-user-tie"></i></td>
