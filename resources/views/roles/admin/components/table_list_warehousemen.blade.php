<div class="table-responsive p-2">
    <table class="table align-items-center mb-0 table-users w-100">
        <thead class="text-white">
            <tr class="bg-primary text-white">
                <th class="text-uppercase text-center text-xxs font-weight-bolder" colspan="5">LISTADO DE ALMACENEROS</th>
            </tr>
            <tr>
        ...
        <tbody>
            @foreach ($warehousemen as $item)
                <tr @if ($loop->last) class="last-row" @endif>
                    ...
                    <td class="align-middle">Almacenero | <i class="fas fa-house-user"></i></td>
