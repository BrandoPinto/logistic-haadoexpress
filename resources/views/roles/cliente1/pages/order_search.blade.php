                    ...
                    <table class="table align-items-center mb-0 table-orders" id="tableOrder">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle"><button class="btn btn-warning btn-sm"
                                        data-bs-toggle="modal" data-bs-target="#modal-delivery-detail"><i
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle"><button class="btn btn-warning btn-sm"
                                        data-bs-toggle="modal" data-bs-target="#modal-fulfillment-detail"><i
                                            class="fas fa-info-circle"></i></button></td>
                            </tr>
                            <tr class="bg-primary">
                                <td colspan="4" class="text-end text-white"><strong>TOTAL GENERAL</strong></td>
                                <td class="text-center">
                                    <span class="text-white font-weight-bold"><strong>S/{{ $grandTotal }}</strong></span>
                                </td>
                                <td></td>
                            </tr>
                        </tbody>
