...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Historial de pedidos'])
    <div class="container-fluid">
        @include('components.alert')
        <div class="card mb-4">
            <div class="card-header pb-0 d-flex justify-content-between">
                <h4 class="p-2"><b>HISTORIAL DE PEDIDOS</b></h4>
            </div>
            <div class="card-body">
                <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0 table-orders" id="tableOrderHistory">
                        <thead>
                            <tr>
