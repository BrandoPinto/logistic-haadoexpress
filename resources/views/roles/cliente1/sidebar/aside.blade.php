...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3 d-flex align-items-center">
            <div class="ps-4">
                <i class="fas fa-briefcase" style="color: #f4645f;"></i>
            </div>
            <h6 class="ms-2 text-uppercase text-xs font-weight-bolder opacity-6 mb-0">Funciones</h6>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'reabastecimiento' ? 'active' : '' }} {{ auth()->user()->hasRole('Cliente2')? 'disabled': '' }}"
                href="{{ route('reabastecimiento') }}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-truck-loading text-dark text-sm opacity-10"></i>
                </div>
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'articulos' ? 'active' : '' }}"
                ...
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-boxes text-dark text-sm opacity-10"></i>
                </div>
                <span class="nav-link-text ms-1">Articulos</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'pedidos' ? 'active' : '' }}"
                href="{{ route('pedidos') }}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-truck-moving text-dark text-sm opacity-10"></i>
                </div>
