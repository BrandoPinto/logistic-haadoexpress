...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'show.orders' ? 'active' : '' }} {{ auth()->user()->hasRole('Cliente2')? 'disabled': '' }}"
                href="{{ route('show.orders') }}">
                <div
                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-truck-loading text-dark text-sm opacity-10"></i>
                </div>
                <span class="nav-link-text ms-1">Historial de mis pedidos</span>
            </a>
        </li>
